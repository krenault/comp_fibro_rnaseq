...
Production DGE is **pairwise**: one DESeq2 fit per contrast (e.g. 2.5 mM vs 8 mM on those samples alone; a separate fit for 30 mM vs 8 mM). Design is `~ individual + treatment`, gene filter **≥5 counts in ≥3 samples within the contrast.**
